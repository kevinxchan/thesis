...
while read name; do
	...
	minimap2 -t $THREADS -a --eqx $WORK_DIR/indexes/minimap2/recA_99_default.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/default.sam
	minimap2 -t $THREADS -a --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_default.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/default_I500k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 11 --eqx $WORK_DIR/indexes/minimap2/recA_99_k11.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k11_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 11 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k11.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k11_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 11 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k11.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k11_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 13 --eqx $WORK_DIR/indexes/minimap2/recA_99_k13.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k13_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 13 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k13.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k13_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 13 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k13.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k13_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 17 --eqx $WORK_DIR/indexes/minimap2/recA_99_k17.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k17_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 17 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k17.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k17_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 17 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k17.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k17_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 19 --eqx $WORK_DIR/indexes/minimap2/recA_99_k19.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k19_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 19 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k19.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k19_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 19 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k19.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k19_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 21 --eqx $WORK_DIR/indexes/minimap2/recA_99_k21.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k21_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 21 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k21.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k21_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 21 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k21.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k21_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 11 -w 3 --eqx $WORK_DIR/indexes/minimap2/recA_99_k13_w3.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k11_w3_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 11 -w 3 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k13_w3.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k11_w3_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 11 -w 3 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k13_w3.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k11_w3_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 13 -w 4 --eqx $WORK_DIR/indexes/minimap2/recA_99_k13_w4.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k13_w4_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 13 -w 4 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k13_w4.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k13_w4_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 13 -w 4 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k13_w4.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k13_w4_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 17 -w 5 --eqx $WORK_DIR/indexes/minimap2/recA_99_k17_w5.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k17_w5_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 17 -w 5 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k17_w5.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k17_w5_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 17 -w 5 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k17_w5.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k17_w5_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 19 -w 6 --eqx $WORK_DIR/indexes/minimap2/recA_99_k19_w6.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k19_w6_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 19 -w 6 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k19_w6.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k19_w6_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 19 -w 6 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k19_w6.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k19_w6_map_ont_I100k.sam	
...
while read name; do
	...
	minimap2 -t $THREADS -ax map-ont -k 21 -w 7 --eqx $WORK_DIR/indexes/minimap2/recA_99_k21_w7.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k21_w7_map_ont.sam
	minimap2 -t $THREADS -ax map-ont -k 21 -w 7 --eqx -I 500000 $WORK_DIR/indexes/minimap2/recA_99_k21_w7.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k21_w7_map_ont_I500k.sam	
	minimap2 -t $THREADS -ax map-ont -k 21 -w 7 --eqx -I 100000 $WORK_DIR/indexes/minimap2/recA_99_k21_w7.mmi $WORK_DIR/raw_data/$name.fastq.gz > $WORK_DIR/processed/minimap2/$name/k21_w7_map_ont_I100k.sam	
